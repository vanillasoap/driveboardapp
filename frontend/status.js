...
var status_handlers = {
  ...
  'server': function (status) {
    if (status.server) {  // server connected
      ...
      $("#status_server").removeClass("badge-danger").addClass("badge-success")
      status_init()
      status.server = true
  ...
  'stops': function (status) {
    ...
    $('#status_limit_y2').removeClass("badge-danger").addClass("badge-success")
    $('#status_limit_z1').removeClass("badge-danger").addClass("badge-success")
    $('#status_limit_z2').removeClass("badge-danger").addClass("badge-success")
    $('#status_requested').removeClass("badge-danger").addClass("badge-success")
    $('#status_buffer').removeClass("badge-danger").addClass("badge-success")
    $('#status_marker').removeClass("badge-danger").addClass("badge-success")
    $('#status_data').removeClass("badge-danger").addClass("badge-success")
    $('#status_command').removeClass("badge-danger").addClass("badge-success")
    $('#status_parameter').removeClass("badge-danger").addClass("badge-success")
    $('#status_transmission').removeClass("badge-danger").addClass("badge-success")
    ...
    if ('stops' in status) {
      if (status.stops.x1) {$('#status_limit_x1').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.x2) {$('#status_limit_x2').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.y1) {$('#status_limit_y1').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.y2) {$('#status_limit_y2').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.z1) {$('#status_limit_z1').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.z2) {$('#status_limit_z2').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.requested) {$('#status_requested').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.buffer) {$('#status_buffer').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.marker) {$('#status_marker').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.data) {$('#status_data').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.command) {$('#status_command').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.parameter) {$('#status_parameter').removeClass("badge-success").addClass("badge-danger")}
      if (status.stops.transmission) {$('#status_transmission').removeClass("badge-success").addClass("badge-danger")}
