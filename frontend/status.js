...
function status_check_new(data1, data2) {
    ...
    else if (typeof (data1) == 'string' || typeof (data1) == 'number' || typeof (data1) == 'boolean' || typeof (data1) == 'undefined') {
        if (data1 !== data2) {
            flag = true
        }
    }
...
var status_handlers = {
    ...
    'server': function (status) {
        if (status.server) { // server connected
            $().uxmessage('success', "Server says greetings!")
            $("#status_server").removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
            status_init()
            status.server = true
        }
        else { // server disconnected
            $().uxmessage('warning', "Server LOST.")
            $("#status_server").removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            // gray-out all dependant indicators
            $('#status_serial').removeClass("badge badge-pill badge-danger badge badge-pill badge-success").addClass("badge badge-pill badge-secondary")
            $(".status_hw").removeClass("badge badge-pill badge-success badge badge-pill badge-danger badge badge-pill badge-warning").addClass("badge badge-pill badge-secondary-light")
        }
        status_set_main_button(status)
    },
    'serial': function (status) {
        if (status.serial) { // serial up
            $('#status_serial').removeClass("badge badge-pill badge-secondary badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        }
        else { // serial down
            $('#status_serial').removeClass("badge badge-pill badge-secondary badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
    ...
    'stops': function (status) {
        ...
        $(".status_hw").removeClass("badge badge-pill badge-secondary")
        $('#status_limit_x1').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_limit_x2').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_limit_y1').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_limit_y2').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_limit_z1').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_limit_z2').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_requested').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_buffer').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_marker').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_data').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_command').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_parameter').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        $('#status_transmission').removeClass("badge badge-pill badge-danger").addClass("badge badge-pill badge-success")
        ...
        if ('stops' in status) {
            if (status.stops.x1) {
                $('#status_limit_x1').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.x2) {
                $('#status_limit_x2').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.y1) {
                $('#status_limit_y1').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.y2) {
                $('#status_limit_y2').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.z1) {
                $('#status_limit_z1').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.z2) {
                $('#status_limit_z2').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.requested) {
                $('#status_requested').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.buffer) {
                $('#status_buffer').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.marker) {
                $('#status_marker').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.data) {
                $('#status_data').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.command) {
                $('#status_command').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.parameter) {
                $('#status_parameter').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
            if (status.stops.transmission) {
                $('#status_transmission').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-danger")
            }
    ...
    'info': function (status) {
        ...
        $(".status_hw").removeClass("badge badge-pill badge-secondary")
        $('#status_door').removeClass("badge badge-pill badge-warning").addClass("badge badge-pill badge-success")
        $('#status_chiller').removeClass("badge badge-pill badge-warning").addClass("badge badge-pill badge-success")
        // set info indicators
        if ('info' in status) {
            if (status.info.door) {
                $('#status_door').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-warning")
            }
            if (status.info.chiller) {
                $('#status_chiller').removeClass("badge badge-pill badge-success").addClass("badge badge-pill badge-warning")
            }
        }
        status_set_main_button(status)
    },
