function controls_ready() {
    ...
    */
    ...
    Mousetrap.bind(['shift+ctrl+up'], function (e) {
    ...
    Mousetrap.bind(['shift+ctrl+down'], function (e) {
    ...
    Mousetrap.bind(['shift+ctrl+left'], function (e) {
    ...
    Mousetrap.bind(['shift+ctrl+right'], function (e) {
